            ...
            <div style="text-align: center;">
                ...
                <p>
                    <button class="btn btn-success"
                            ...
                            onclick="return goTo(this);"
                            aria-label="<?php esc_attr_e( 'Go to URL', 'hocwp-theme' ); ?>"><?php _e( 'Continue to this url', 'hocwp-theme' ); ?></button>
                    <button class="btn btn-danger" onclick="goBack()"
                            aria-label="<?php esc_attr_e( 'Go back', 'hocwp-theme' ); ?>"><?php _e( 'Go back', 'hocwp-theme' ); ?></button>
                </p>
