...
if ( ! function_exists( 'hocwp_theme_setup' ) ) :
	...
	function hocwp_theme_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'hocwp_theme_custom_background_args', array(
...
function hocwp_theme_scripts() {
	wp_enqueue_style( 'hocwp-theme-style', get_stylesheet_uri() );

	wp_enqueue_script( 'hocwp-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'hocwp-theme-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
