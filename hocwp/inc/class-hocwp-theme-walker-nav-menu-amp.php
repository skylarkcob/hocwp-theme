...
if ( ! class_exists( 'HOCWP_Theme_Walker_Nav_Menu_AMP' ) ) {
	 ...
	 */
	class HOCWP_Theme_Walker_Nav_Menu_AMP extends HOCWP_Theme_Walker_Nav_Menu {
		...
		public function nav_menu_start_el_filter( $item_output, $item ) {
			...
			$before = '<input type="checkbox" id="show-menu-' . $item->ID . '" role="button" class="show-menu-input">';

			$item_output = $before . $item_output;

			$item_output .= '<label for="show-menu-' . $item->ID . '" class="show-menu image-sprites"></label>';
			$item_output .= '<label for="show-menu-' . $item->ID . '" class="hide-menu image-sprites"></label>';
