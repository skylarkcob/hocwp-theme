...
class HOCWP_Theme_Widget_Posts extends WP_Widget {
	...
	public function form( $instance ) {
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id( 'crop_thumbnail' ); ?>"><?php _e( 'Crop thumbnail to exact dimensions?', 'hocwp-theme' ); ?></label>
        </p>
        <div style="margin: 1em 0">
			<?php
			$args = array(
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'meta_key' ); ?>"><?php _e( 'Meta key:', 'hocwp-theme' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'meta_value' ); ?>"><?php _e( 'Meta value:', 'hocwp-theme' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number of posts to show:', 'hocwp-theme' ); ?></label>
            <input class="tiny-text" id="<?php echo $this->get_field_id( 'number' ); ?>"
                   name="<?php echo $this->get_field_name( 'number' ); ?>" type="number" step="1" min="1"
                   value="<?php echo $number; ?>" size="3"/>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id( 'title_length' ); ?>"><?php _e( 'Post title length:', 'hocwp-theme' ); ?></label>
        ...
        <fieldset>
            ...
            <p>
                ...
                <label for="<?php echo $this->get_field_id( 'show_date' ); ?>"><?php _e( 'Display post date?', 'hocwp-theme' ); ?></label>
            </p>
            <p>
                ...
                <label for="<?php echo $this->get_field_id( 'show_author' ); ?>"><?php _e( 'Display post author?', 'hocwp-theme' ); ?></label>
            </p>
            <p>
                ...
                <label for="<?php echo $this->get_field_id( 'show_comment_count' ); ?>"><?php _e( 'Display post comment count?', 'hocwp-theme' ); ?></label>
            </p>
        </fieldset>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id( 'show_excerpt' ); ?>"><?php _e( 'Display post excerpt?', 'hocwp-theme' ); ?></label>
        </p>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id( 'related' ); ?>"><?php _e( 'Display related posts?', 'hocwp-theme' ); ?></label>
        </p>
        <p>
			<?php
			$args = array(
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id( 'term_as_title' ); ?>"><?php _e( 'Display term as widget title?', 'hocwp-theme' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo $this->get_field_id( 'title_term_link' ); ?>"><?php _e( 'Use term link for widget title?', 'hocwp-theme' ); ?></label>
        </p>
		<?php
