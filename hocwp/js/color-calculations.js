 ...
 * @return {Object} - this
 */
function _hocwpThemeColor(backgroundColor, accentHue) {
 ...
 * @return {Object} - this
 */
_hocwpThemeColor.prototype.setAccentColorsArray = function () {
    var self = this,
        minSaturation = 65,
        maxSaturation = 100,
        minLightness = 30,
 ...
 */
_hocwpThemeColor.prototype.getTextColor = function () {
 ...
 * @return {Color} - Returns a Color object.
 */
_hocwpThemeColor.prototype.getAccentColor = function () {
    var fallback;
...
/**
 * Return a new instance of the _hocwpThemeColor object.
 *
 * @param {string} backgroundColor - The background color.
 * @param {number} accentHue - The hue for our accent color.
 * @return {Object} - this
 */
function hocwpThemeColor(backgroundColor, accentHue) {// jshint ignore:line
    var color = new _hocwpThemeColor(backgroundColor, accentHue);
